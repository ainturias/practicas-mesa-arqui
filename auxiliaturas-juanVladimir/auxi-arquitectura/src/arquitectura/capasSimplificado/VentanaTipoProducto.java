...
public class VentanaTipoProducto extends javax.swing.JFrame {
    ...
    private void listar() {
        Object[][] datos = negocio.listar();
        DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
        model.setRowCount(0);
        int i = 1;
        for (Object[] d : datos) {
            model.addRow(new Object[]{i++, d[0]});
//            model.addRow(new Object[]{i++, d[0], d[1], d[2]});  // 3 columnas
        }
    }
    ...
    private void guardar() {
        ...
        if (id > 0) {
            ...
            JOptionPane.showMessageDialog(this, "Error: ingrese descripción");
        }
    }
